...
public class Play {
	...
	private  LetterGenerated randomLetter;
    ...
    public static void main(String[] args) {
        Play LetterGameConsole = new Play();
    }
    ...
    public void startGame(){
    	...
    	randomLetter = new LetterGenerated();
    	...
    	letterBag.addLetter(p1Letter);
    	letterBag.addLetter(p2Letter);
    ...
    public void play(){
    	...
    	while(!entry.equals("q")){
    		...
    		if(currentPlayer.getbWordFound() == false ){
    			...
    			letterBag.addLetter(letterpicked);
    			letterpicked=currentPlayer.pick(randomLetter);
    			System.out.println(currentPlayer+" draws "+letterpicked);
    			letterBag.addLetter(letterpicked);
    			System.out.println("Letters in the bag : "+ letterBag.getlListOfLetterOnLetterBag());
    	
    			if(currentPlayer==player1){
    				System.out.println( player2 +" : " + player2.getWordsFound());
    				
    				wordPlayer=currentPlayer.makeword(letterBag, player2.getWordsFound());
    				traitementJeu(wordPlayer);
    			}else{
    				System.out.println(player1 +" : " + player1.getWordsFound());
    				wordPlayer=currentPlayer.makeword(letterBag, player1.getWordsFound());
    				traitementJeu(wordPlayer);
    			}
